...
#define CA_SECURITY_EXT_BUFFER_CB (DWORD)512
...
#define CA_SECURITY_EXT_ASN_MIN_CB (DWORD)27
...
#define OBJECTSID_OID_A "1.3.6.1.4.1.311.25.2.1"
...
#define OBJECTSID_OID_VALUE_CB (DWORD)10

// Size of the OID (see above) including the type and length bytes
#define OBJECTSID_OID_TLV_CB (OBJECTSID_OID_VALUE_CB + (DWORD)2)
