     ...
     */
     {
         ...
         L"Microsoft: Security Catalogues - Security Catalogue List",
         CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
         NULL,
         NULL
    },
     {
         ...
         L"Microsoft: Security Catalogues - Security Catalogue v1",
         CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
         NULL,
         NULL
     },
     {
         ...
         L"Microsoft: Security Catalogues - Security Catalogue v2",
         CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
         NULL,
         NULL
     },
