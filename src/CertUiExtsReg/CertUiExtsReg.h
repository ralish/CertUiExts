...
CERTUIEXTS_REG_INFO g_rgRegInfo[] = {
     ...
     */
    {
        ...
        L"AD DS: CA Security",
        L"Microsoft: Active Directory - CA Security extension",
    ...
    },
    {
        ...
        L"AD DS: Object SID",
        L"Microsoft: Active Directory - Object SID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        NULL,
        NULL
    },
     ...
     */
    {
        ...
        L"ASP.NET Core: HTTPS Development",
        L"Microsoft: ASP.NET Core - HTTPS Development extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
     ...
     */
    {
        ...
        L"Statement Type",
        L"Microsoft: Authenticode - Statement Type attribute",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
    ...
    },
    {
        ...
        L"Publisher Info",
        L"Microsoft: Authenticode - Publisher Info attribute",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
     ...
     */
    {
        ...
        L"Privacy CA Encryption",
        L"Microsoft: Certificate Services - Privacy CA Encryption EKU",
        CRYPT_ENHKEY_USAGE_OID_GROUP_ID,
        NULL,
        NULL
    },
...
#ifdef _DEBUG
    {
        ...
        L"Microsoft: Defender for Endpoint - Unknown (4) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
...
#endif
    {
        ...
        L"Microsoft: Defender for Endpoint - Entra ID Tenant ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
#ifdef _DEBUG
    {
        ...
        L"Microsoft: Defender for Endpoint - Unknown (15) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
    ...
    },
    {
        ...
        L"Microsoft: Defender for Endpoint - Unknown (17) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
#endif
    {
        ...
        L"Microsoft: Defender for Endpoint - Entra ID Device ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
     ...
     */
    {
        ...
        L"Microsoft: Entra ID - NTDS-DSA Invocation ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        ...
        L"Microsoft: Entra ID - Device ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        ...
        L"Entra ID: User ID",
        L"Microsoft: Entra ID - User ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        ...
        L"Microsoft: Entra ID - Domain ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        ...
        L"Microsoft: Entra ID - Tenant ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        ...
        L"Microsoft: Entra ID - Join Type extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
    ...
    },
    {
        ...
        L"Microsoft: Entra ID - Tenant Region extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
     ...
     */
    {
        "1.2.840.113556.5.4",
        L"Intune: Device ID",
        L"Microsoft: Intune - Device ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
    ...
    },
    {
        "1.2.840.113556.5.6",
        L"Intune: Account ID",
        L"Microsoft: Intune - Account ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
    {
        "1.2.840.113556.5.10",
        L"Intune: User ID",
        L"Microsoft: Intune - User ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
#ifdef _DEBUG
    {
        "1.2.840.113556.5.11",
        L"Intune: Unknown (11)",
        L"Microsoft: Intune - Unknown (11) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
#endif
    {
        ...
        L"Microsoft: Intune - Entra ID Tenant ID extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnGuid"
    },
#ifdef _DEBUG
    {
        "1.2.840.113556.5.15",
        L"Intune: Unknown (15)",
        L"Microsoft: Intune - Unknown (15) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
    {
        "1.2.840.113556.5.16",
        L"Intune: Unknown (16)",
        L"Microsoft: Intune - Unknown (16) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
    {
        "1.2.840.113556.5.17",
        L"Intune: Unknown (17)",
        L"Microsoft: Intune - Unknown (17) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
    {
        "1.2.840.113556.5.18",
        L"Intune: Unknown (18)",
        L"Microsoft: Intune - Unknown (18) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
    {
        "1.2.840.113556.5.19",
        L"Intune: Unknown (19)",
        L"Microsoft: Intune - Unknown (19) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        CRYPT_FORMAT_OBJECT_A,
        "FormatGenericAsnInteger"
    },
    {
        "1.2.840.113556.5.23",
        L"Intune: Unknown (23)",
        L"Microsoft: Intune - Unknown (23) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        NULL,
        NULL
    },
    {
        "1.2.840.113556.5.24",
        L"Intune: Unknown (24)",
        L"Microsoft: Intune - Unknown (24) extension",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        NULL,
        NULL
    },
     ...
     */
    {
        ...
        L"Microsoft: Timestamping - Timestamp Signature attribute",
        CRYPT_EXT_OR_ATTR_OID_GROUP_ID,
        NULL,
        NULL
    },
     ...
     */
    {
        ...
        L"Netscape: Server Gated Cryptography (SGC) EKU",
        CRYPT_ENHKEY_USAGE_OID_GROUP_ID,
        NULL,
        NULL
    },
     ...
     * 1.3.6.1.4.1.6449
     *
     * Formerly Comodo CA prior to rebranding.
     */
    {
     ...
     * 2.16.840.1.113733
     *
     * PKI services acquired by Symantec then later sold to DigiCert.
     */
    {
        "2.16.840.1.113733.1.8.1",
        L"Verisign Server Gated Cryptography (SGC)",
        L"Verisign: Server Gated Cryptography (SGC) EKU",
        CRYPT_ENHKEY_USAGE_OID_GROUP_ID,
        NULL,
        NULL
    }
